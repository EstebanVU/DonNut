...
class PreparationDetail extends StatefulWidget {
  const PreparationDetail({Key? key}) : super(key: key);
 
  @override
  State<PreparationDetail> createState() => PreparationDetailState();
}

int subtotal = 0;

class PreparationDetailState extends State<PreparationDetail> {
  ...
  Widget build(BuildContext context) {
    final arguments =
    ModalRoute.of(context)!.settings.arguments as PreparationDetailArguments;
...
class PreparationDetailArguments {
  int idPedido;
  String nombre;
  PreparationDetailArguments(
